...
{
    [TestClass]
    public class TraditionalTestsV2 : BaseTests
    {
        static RemoteWebDriver driver;
        static string fileName = "Traditional-V2-TestResults.txt";
        static string appURL = appliFashionV2URL; 
        ...
        public void ProductDetailsInLaptopModeTest(BrowserType browserType, int width, int height)
        {
            ...
            driver.FindElementByXPath(PLPage.appliAirNightShoeAnchorTagV2Locator).Click();
            InduceDelay(2);
