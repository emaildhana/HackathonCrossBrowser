...
namespace HackathonCrossBrowser.ModernVisualAIApproachTests
{
    ...
    public class ModernTestsV1
    {
        ...
        private static string appliFashionV1URL = "https://demo.applitools.com/gridHackathonV1.html";
        ...
        public void ProductDetailsTest()
        {
            ...
            webDriver.FindElement(By.XPath(PLPage.appliAirNightShoeAnchorTagLocator)).Click();
            InduceDelay(2);
